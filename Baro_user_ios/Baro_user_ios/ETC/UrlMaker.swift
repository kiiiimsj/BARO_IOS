...
class NetWorkURL {
    ...
    //상세 주문내역 뽑기(기본적인것)
    let orderHistoryDetail = "http://15.165.22.64:8080/OrderDefaultFindByReceiptId.do"
    //상세 주문내역 뽑기(extra)
    let orderHistoryDetailExtra = "http://15.165.22.64:8080/OrderExtraFindByOrderId.do"
}
