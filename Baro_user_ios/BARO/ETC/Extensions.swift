...
extension UIColor {
    ...
    static var customDarkGray = UIColor.init(red: 52/255, green: 52/255, blue: 52/255, alpha: 1)
}
extension String {
    // 취소선 긋기
    func strikeThrough() -> NSAttributedString {
        ...
        attributeString.addAttribute(NSAttributedString.Key.strikethroughColor, value: UIColor.customLightGray, range: NSMakeRange(0,attributeString.length))
